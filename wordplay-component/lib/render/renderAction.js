...
/*#__PURE__*/
function (_Render) {
  _inherits(RenderAction, _Render);

  function RenderAction() {
    _classCallCheck(this, RenderAction);

    return _possibleConstructorReturn(this, _getPrototypeOf(RenderAction).call(this));
  }
  ...
  _createClass(RenderAction, [{
    ...
    value: function drawActionButton(parentElement, name, onAction) {
