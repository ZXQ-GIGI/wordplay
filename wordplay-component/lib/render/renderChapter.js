...
/*#__PURE__*/
function (_Render) {
  _inherits(RenderChapter, _Render);

  function RenderChapter() {
    _classCallCheck(this, RenderChapter);

    return _possibleConstructorReturn(this, _getPrototypeOf(RenderChapter).call(this));
  }

  _createClass(RenderChapter, [{
    key: "draw",
    value: function draw(parentElement, options) {
      this.clear();
      this.initWrapperElement(); // console.log(this.wrapperElement);
